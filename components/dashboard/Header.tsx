...
export const Header: React.FC<HeaderProps> = ({ user, selectedKey, onSelectKey, onLogout, onOpenCampaigns }) => {
  return (
    <header className="mb-8 flex flex-col md:flex-row justify-between items-center gap-4 border-b border-dark-700 pb-6">
      <div>
          ...
          <p className="text-dark-700 text-sm mt-1 text-gray-400">Powered by Gemini 3 & Nano Banana Pro</p>
      </div>
